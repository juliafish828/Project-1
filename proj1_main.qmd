...
We will now utilize all of the functions we have written to take in raw data, preprocess it, split it into two tibbles, and plot them accordingly. Some examples are below.
